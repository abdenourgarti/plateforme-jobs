...
const JobInformation = ({ onNext, onBack }) => {
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 mt-4">
        ...
        <div>
          ...
          />
          <label htmlFor="jobTitle" className="block font-light text-sm text-gray-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 mt-4">
        {/* Left: Heading */}
        <div>
          <h2 className="text-lg font-semibold mb-2">Type of Employment</h2>
          <p className="text-sm text-gray-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 mt-4">
        ...
        <button
          onClick={() =>
            setFormData((prevData) => ({
              ...prevData,
              requiredSkills: [...prevData.requiredSkills, ''],
            }))
          }
