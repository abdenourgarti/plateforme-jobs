...
const Dashboard = () => {
  ...
  {/* Doughnut Chart */}
  <div className="flex-1 bg-white p-6  border flex flex-col justify-between">
    <h4 className="text-gray-500 text-xl font-semibold mb-4">Jobs Applied Status</h4>
    <div className="flex items-center">
      <div className="relative w-24 h-24 mr-6">
        <div
          className="absolute inset-0 rounded-full"
          style={{
            background: `conic-gradient(#EF4444 ${unsuitablePercentage}%,  #EEEEEE 0)`,
          }}
        >
    ...
    <div className="mt-4">
      ...
      <div className="bg-white rounded-xl shadow-sm border">
        ...
        <div className="p-4 text-right border-t">
          <Link href="/applications/history" className="text-red-500  text-sm flex items-center justify-center hover:text-red-600">
